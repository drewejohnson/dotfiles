...
function __promptline {
  ...
  local a_bg="${wrap}48;5;101${end_wrap}"
  local a_sep_fg="${wrap}38;5;101${end_wrap}"
  local b_fg="${wrap}38;5;101${end_wrap}"
  local b_bg="${wrap}48;5;238${end_wrap}"
  local b_sep_fg="${wrap}38;5;238${end_wrap}"
  local c_fg="${wrap}38;5;101${end_wrap}"
  local c_bg="${wrap}48;5;235${end_wrap}"
  local c_sep_fg="${wrap}38;5;235${end_wrap}"
  local warn_fg="${wrap}38;5;131${end_wrap}"
  local warn_bg="${wrap}48;5;0${end_wrap}"
  local warn_sep_fg="${wrap}38;5;0${end_wrap}"
  local y_fg="${wrap}38;5;101${end_wrap}"
  local y_bg="${wrap}48;5;238${end_wrap}"
  local y_sep_fg="${wrap}38;5;238${end_wrap}"
  local z_fg="${wrap}38;5;238${end_wrap}"
  local z_bg="${wrap}48;5;101${end_wrap}"
  local z_sep_fg="${wrap}38;5;101${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
