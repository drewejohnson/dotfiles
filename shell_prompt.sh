...
function __promptline {
  ...
  local a_fg="${wrap}38;5;145${end_wrap}"
  ...
  local warn_fg="${wrap}38;5;167${end_wrap}"
  local warn_bg="${wrap}48;5;16${end_wrap}"
  local warn_sep_fg="${wrap}38;5;16${end_wrap}"
  local y_fg="${wrap}38;5;0${end_wrap}"
  local y_bg="${wrap}48;5;59${end_wrap}"
  local y_sep_fg="${wrap}38;5;59${end_wrap}"
  local z_fg="${wrap}38;5;145${end_wrap}"
